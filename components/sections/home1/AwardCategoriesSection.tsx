			...
			<div className="image-cards-wrapper">
				<div className="container">
					<div className="image-cards-grid image-cards-grid-all">
						...
						<div className="image-card">
							<div className="card-image-wrapper">
								<img src="/assets/img/all-images/categories/Industry Excellence.jpg" alt="Industry Excellence" />
							</div>
							<div className="card-content-box">
						...
						<div className="image-card">
							<div className="card-image-wrapper">
								<img src="/assets/img/all-images/categories/Enterprise Awards.webp" alt="Enterprise Awards" />
							</div>
							<div className="card-content-box">
						...
						<div className="image-card">
							<div className="card-image-wrapper">
								<img src="/assets/img/all-images/categories/Institutional & Enabler.jpg.avif" alt="Institutional & Enabler" />
							</div>
							<div className="card-content-box">
