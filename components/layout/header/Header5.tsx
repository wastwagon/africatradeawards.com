														...
														<div className="col-lg-12">
															<div className="all-images-menu">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index2"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index3"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index4"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb" style={{ margin: 0 }}>
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index5"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
															...
															<div className="all-images-menu">
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index6"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index7"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index8"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index9"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb" style={{ margin: 0 }}>
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn5" href="/index10"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
