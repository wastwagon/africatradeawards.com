								...
								<div className="header-elements">
									...
									<div className="main-menu">
										<ul>
														...
														<div className="col-lg-12">
															<div className="all-images-menu">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index2">View Demo <span><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index3">View Demo <span><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index4">View Demo <span><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb" style={{ margin: 0 }}>
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index5">View Demo <span><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
															...
															<div className="all-images-menu">
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index6">View Demo <span><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index7">View Demo <span><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index8">View Demo <span><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index9">View Demo <span><i className="fa-solid fa-arrow-right" /></span>
																		</Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb" style={{ margin: 0 }}>
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn7" href="/index10">View Demo
											...
											<li><Link href="/#">Blogs <i className="fa-solid fa-angle-down" /></Link>
												<ul className="dropdown-padding">
